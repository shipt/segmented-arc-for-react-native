...
| arcStartAngle               | number                                                                                                    | 90                                         | Angle (in degrees) at which the arc is centered. The arc spans symmetrically around this value, so the arc starts at `arcStartAngle - arcDegree / 2`.                                                                                                                                                                                                                                                                         |
